...
<head>
  ...
  <style>
    ...
    .footer-content {
      ...
      max-width: 1200px;
      /* Ya jitni aapki site ki max-width hai */
      margin: 0 auto;
      padding: 40px 20px;
    }
    ...
    .footer-logo-hrca img {
      ...
      /* Logo ko white karne ke liye (agar original color ho) */
      margin-bottom: 15px;
    }
    ...
    .social-icon-hrca.facebook {
      background-color: #3b5998;
    }

    .social-icon-hrca.twitter {
      background-color: #00acee;
    }

    .social-icon-hrca.youtube {
...
<body>
  ...
  ?>
          ...
          <?php while ($ebook = $result->fetch_assoc()): ?>
            <div class="col-md-3 col-sm-6 mb-4">
              <div class="card shadow-sm h-100 text-center">
                <img src="<?php echo htmlspecialchars($ebook['cover_image']); ?>" class="card-img-top"
                ...
                <div class="card-body">
                  ...
                  <a href="<?php echo htmlspecialchars($ebook['file_path']); ?>" class="btn btn-primary btn-sm"
                    target="_blank">
                    View
                  </a>
                  <a href="<?php echo htmlspecialchars($ebook['file_path']); ?>" class="btn btn-primary btn-sm" download>
                    Download
                  </a>
                  <a href="rate_submit.php?id=<?php echo $ebook['id']; ?>" class="btn btn-primary btn-sm">
                    Rate
                  </a>
    ...
    <footer class="main-footer">
      ...
      <div>
        All Rights Reserved © <?= date("Y") ?> F.G. Degree College For Women, Kharian Cantt. | Made with ❤ by <b>Aqsa
          Hakeem, Maleeha and Iqra Noureen (BSIT)</b>
      </div>
      </div>
    </footer>
