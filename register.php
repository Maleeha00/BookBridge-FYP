                ...
                <?php if (!empty($message)): ?>
                    ...
                    <?php if ($messageType == 'success' && !empty($generatedId)): ?>
                        <div class="unique-id-display">
                            ...
                            <p><strong>Important:</strong> Save this ID safely. You can use either your email or this unique ID
                                to login.</p>
                            <a href="login.php" class="btn-auth"
                                style="display: inline-block; margin-top: 15px; text-decoration: none; width: auto; padding: 12px 24px;">
                ...
                <?php if ($messageType != 'success'): ?>
                    <form method="POST" action="" id="registerForm">
                        <div class="form-row">
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <small id="nameWarning" style="color: red; display: none;">Only alphabets and spaces are
                                        allowed.</small>
                                </div>
                            </div>
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <small id="emailWarning" style="color: red; display: none;">Enter valid email address.
                                        <br> email@gmail.com</small>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <div class="password-requirements" id="passwordRequirements">
                                        ...
                                        <div class="requirement" id="length-req"><i class="fas fa-times"></i><span>At least
                                                8 characters long</span></div>
                                        <div class="requirement" id="uppercase-req"><i class="fas fa-times"></i><span>At
                                                least one uppercase letter (A-Z)</span></div>
                                        <div class="requirement" id="special-req"><i class="fas fa-times"></i><span>At least
                        ...
                        <div style="text-align: center;">
                            <a href="login.php" class="btn-link-auth">
