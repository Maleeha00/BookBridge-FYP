   ...
   <nav class="auth-navbar">
    <div class="container" style="display: flex;">
        <a href="login.php" class="auth-logo" style="display: flex;">
            <img src="uploads/assests/book.jpg" alt="Library Logo" style="height: 40px;">
                ...
                <?php if (!empty($message)): ?>
                    ...
                    <?php if ($messageType == 'success' && !empty($generatedId)): ?>
                        <div class="unique-id-display">
                            ...
                            <a href="login.php" class="btn-auth" style="display: inline-block; margin-top: 15px; text-decoration: none; width: auto; padding: 12px 24px;">
