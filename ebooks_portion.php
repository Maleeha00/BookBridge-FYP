...
$viewMore = isset($_GET['view']) ? $_GET['view'] : '';

if ($viewMore !== "all") {
    $sql .= " ORDER BY e.created_at DESC LIMIT 11";
} else {
...
<div class="container">
    ...
    <?php if (count($ebooks) > 0): ?>
        <div class="ebooks-grid">
            ...
            <?php endforeach; ?>
            <?php if ($viewMore !== "all" && count($ebooks) == 11): ?>
    <div style="text-align:center; margin-top:20px;">
        <a href="ebooks.php?view=all" class="btn btn-primary" style="padding:10px 20px; font-size:16px;">
            View More
        </a>
    </div>
<?php endif; ?>
