        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    ...
                    <strong>Important:</strong> You have <?php echo count($awaitingCollection); ?> approved book request(s)
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php foreach (array_slice($currentlyIssued, 0, 3) as $book):
                                    ...
                                    $issueDate = new DateTime($book['issue_date']);
                                    $returnDate = new DateTime($book['return_date']);
                                    $today = new DateTime();

                                    
                                    $totalDuration = $issueDate->diff($returnDate)->days;
                                    if ($totalDuration <= 0)
                                        $totalDuration = 1; 
                                    ...
                                    $percentage = ($daysRemaining > 0) ? ($daysRemaining / $totalDuration) * 100 : 0;
                                    ...
                                    $isOverdue = ($today > $returnDate && $daysRemaining <= 0);
                                    $barClass = 'bg-success'; 
                                    $showWarning = false;
                                    ...
                                    <tr>
                                        ...
                                        <td style="min-width: 150px;">
                                            <div class="custom-progress-container"
                                                title="Total Days: <?php echo $totalDuration; ?>">
                                                <div class="custom-progress-bar <?php echo $barClass; ?>"
                                                    style="width: <?php echo $percentage; ?>%">
                                                </div>
                                            </div>
                                            <small
                                                class="days-label <?php echo ($showWarning || $isOverdue) ? 'text-danger font-weight-bold' : ''; ?>">
                                                <?php if ($isOverdue): ?>
                                                    <i class="fas fa-exclamation-triangle"></i> Overdue!
                                                <?php else: ?>
                                                    <?php if ($showWarning)
                                                        echo '<i class="fas fa-hourglass-end"></i> '; ?>
